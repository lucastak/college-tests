...
class CilindroTestParametrized {
    ...
    void deveCalcularAreaDoCilindro(Circulo base, double altura) {
        this.base = base;
        this.cilindro = new Cilindro(this.base, altura);

        double esperado = 2 * this.base.area() + altura * this.base.perimetro();
        assertEquals(esperado, this.cilindro.area(), 0.0001);
    }
    ...
    void deveCalcularVolumeDoCilindro(double raio, double altura) {
        ...
        cilindro = new Cilindro(base, altura);
